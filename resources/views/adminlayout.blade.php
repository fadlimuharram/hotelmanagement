<?php
$userpicloc = (Auth::user()->picture) ? Auth::user()->picture : "defaultuser.png";
 ?>
<!DOCTYPE html>
<!--
...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('adminlte/default.css') }}">
...
@include('admin.menuatas')
@include('admin.menukiri')

  <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
    <section class="content-header">
      @include('admin.menubreadcumb')
    </section>
...
<!-- jQuery 2.2.3  -->
<script src="{{ asset('adminlte/jquery-3.2.1.min.js') }}"></script>
<!-- Bootstrap 3.3.6 -->
...
<script src="{{ asset('adminlte/default.js') }}"></script>
